 ...
 * @endcode
 */
$settings['hash_salt'] = 'Y1lEBHFQK832Aa8JWktD66_MZjVywBFhzs4y-qD5JIPZ1emcha2vb42-qh4bpBE2IV9Yv1KSLg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_sbmea_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_sbmea_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'sbmea',
...
$config_directories['sync'] = 'sites/sbmea.dd/files/config_1Oae4MwAGCI2zUfWJWSvlNs8VtjfRe-c6WXyrc59W52hHIcGKtrxZJ6yZ-CGg7gVg_exQOoxAQ/sync';
